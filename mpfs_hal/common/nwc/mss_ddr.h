...
#define DDR_FPFA_DQ_DRIVE ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<9U))>>9U)
#define DDR_FPFA_DQS_DRIVE ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<11U))>>11U)
#define DDR_FPFA_ADD_CMD_DRIVE ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<13U))>>13U)
#define DDR_FPFA_CLOCK_OUT_DRIVE ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<15U))>>15U)

#define DDR_FPFA_DQ_TERMINATION ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<17U))>>17U)
#define DDR_FPFA_DQS_TERMINATION ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<19U))>>19U)
#define DDR_FPFA_ADD_CMD_TERMINATION ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<21U))>>21U)
#define DDR_FPFA_PRESET_ODT_CLK ((LIBERO_SETTING_DDRPHY_MODE & (0x3U<<23U))>>23U)
