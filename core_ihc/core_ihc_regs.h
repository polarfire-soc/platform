...
typedef uint32_t (*QUEUE_IHC_INCOMING)(uint32_t ,  uint32_t *, uint32_t );
...
#define MSG_AVAIL_CHAN0         (0x01U << 0U)
#define MSG_AVAIL_CHAN1         (0x01U << 1U)
#define MSG_AVAIL_CHAN2         (0x01U << 2U)
#define MSG_AVAIL_CHAN3         (0x01U << 3U)
#define MSG_AVAIL_CHAN4         (0x01U << 4U)

typedef union{                       /*!< IPCA_IP_MSG_AVAIL_STAT register definition*/
    __IO  uint32_t                        MSG_AVAIL;
    struct
    {
    __IO  uint32_t              MP_H0        :1;
    __IO  uint32_t              ACK_H0       :1;
    __IO  uint32_t              MP_H1        :1;
    __IO  uint32_t              ACK_H1       :1;
    __IO  uint32_t              MP_H2        :1;
    __IO  uint32_t              ACK_H2       :1;
    __IO  uint32_t              MP_H3        :1;
    __IO  uint32_t              ACK_H3       :1;
    __IO  uint32_t              MP_H4        :1;
    __IO  uint32_t              ACK_H4       :1;
    __IO   uint32_t             reserved     :22;
    } bitfield;
} IPCA_IP_MSG_AVAIL_STAT_TypeDef;

typedef union{                       /*!< IPCA_IP_INT_EN_TypeDef register definition*/
...
} IPCA_IP_INT_EN_TypeDef;

typedef struct
{
  __IO  uint32_t  version;
  __IO  IPCA_IP_INT_EN_TypeDef			INT_EN;
  __IO  IPCA_IP_MSG_AVAIL_STAT_TypeDef  MSG_AVAIL_STAT;
} IPCA_IP_TypeDef;
...
typedef struct
{
  ...
  QUEUE_IHC_INCOMING  msg_in_handler;
...
typedef struct IHC_TypeDef_
{
    ...
    __IO  IPCA_IP_TypeDef *interrupt_concentrator;
    IPC_DRIVER_HART_INFO_TypeDef local_h_setup;
} IHC_TypeDef;

#ifndef DEBUG_IHC
#define COMMON_AHB_BASE_ADD     0x40000000UL
#define IHC_HO_BASE_OFFSET      0x04000000UL
#define IHC_H1_BASE_OFFSET      0x05000000UL
#define IHC_H2_BASE_OFFSET      0x06000000UL
#define IHC_H3_BASE_OFFSET      0x07000000UL
#define IHC_H4_BASE_OFFSET      0x08000000UL
...
#ifndef IHC_LOCAL_H0_REMOTE_H1
#define IHC_LOCAL_H0_REMOTE_H1      0x8020080
#endif

#ifndef IHC_LOCAL_H0_REMOTE_H2
#define IHC_LOCAL_H0_REMOTE_H2      0x8020100
#endif

#ifndef IHC_LOCAL_H0_REMOTE_H3
#define IHC_LOCAL_H0_REMOTE_H3      0x8020180
#endif

#ifndef IHC_LOCAL_H0_REMOTE_H4
#define IHC_LOCAL_H0_REMOTE_H4      0x8020200
#endif

#ifndef IHCA_LOCAL_H0
#define IHCA_LOCAL_H0               0x8020280
#endif

/************** My Hart 1 ************/

#ifndef IHC_LOCAL_H1_REMOTE_H0
#define IHC_LOCAL_H1_REMOTE_H0      0x8030000
#endif

#ifndef IHC_LOCAL_H1_REMOTE_H2
#define IHC_LOCAL_H1_REMOTE_H2      0x8030100
#endif

#ifndef IHC_LOCAL_H1_REMOTE_H3
#define IHC_LOCAL_H1_REMOTE_H3      0x8030180
#endif

#ifndef IHC_LOCAL_H1_REMOTE_H4
#define IHC_LOCAL_H1_REMOTE_H4      0x8030200
#endif

#ifndef IHCA_LOCAL_H1
#define IHCA_LOCAL_H1               0x8030280
#endif

/************** My Hart 2 ************/

#ifndef IHC_LOCAL_H2_REMOTE_H0
#define IHC_LOCAL_H2_REMOTE_H0      0x8040000
#endif

#ifndef IHC_LOCAL_H2_REMOTE_H1
#define IHC_LOCAL_H2_REMOTE_H1      0x8040080
#endif

#ifndef IHC_LOCAL_H2_REMOTE_H3
#define IHC_LOCAL_H2_REMOTE_H3      0x8040180
#endif

#ifndef IHC_LOCAL_H2_REMOTE_H4
#define IHC_LOCAL_H2_REMOTE_H4      0x8040200
#endif

#ifndef IHCA_LOCAL_H2
#define IHCA_LOCAL_H2               0x8040280
#endif

/************** My Hart 3 ************/

#ifndef IHC_LOCAL_H3_REMOTE_H0
#define IHC_LOCAL_H3_REMOTE_H0      0x8050000
#endif

#ifndef IHC_LOCAL_H3_REMOTE_H1
#define IHC_LOCAL_H3_REMOTE_H1      0x8050080
#endif

#ifndef IHC_LOCAL_H3_REMOTE_H2
#define IHC_LOCAL_H3_REMOTE_H2      0x8050100
#endif

#ifndef IHC_LOCAL_H3_REMOTE_H4
#define IHC_LOCAL_H3_REMOTE_H4      0x8050200
#endif

#ifndef IHCA_LOCAL_H3
#define IHCA_LOCAL_H3               0x8050280
#endif

/************** My Hart 4 ************/

#ifndef IHC_LOCAL_H4_REMOTE_H0
#define IHC_LOCAL_H4_REMOTE_H0      0x8060000
#endif

#ifndef IHC_LOCAL_H4_REMOTE_H1
#define IHC_LOCAL_H4_REMOTE_H1      0x8060080
#endif

#ifndef IHC_LOCAL_H4_REMOTE_H2
#define IHC_LOCAL_H4_REMOTE_H2      0x8060100
#endif

#ifndef IHC_LOCAL_H4_REMOTE_H3
#define IHC_LOCAL_H4_REMOTE_H3      0x8060180
#endif

#ifndef IHCA_LOCAL_H4
#define IHCA_LOCAL_H4               0x8060280
#endif

#endif  /* #ifndef DEBUG_IHC */
